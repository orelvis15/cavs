...
|---|---:|---:|---:|---:|
| adjacent pairwise diffs | 1.54 | 4 | 9 | 46 ms |
| sparse dyadic ladder (aligned) | 1.20 | 3 | 4 | 35 ms |
| base hub (v06, bidirectional) | 1.76 | 2 | 2 | 45 ms |
| hot pairs (latest:3) + adjacent baseline | 1.42 | 4 | 7 | 41 ms |
| all-pairs theoretical one-hop baseline | 0.99 | 1 | 1 | 29 ms |
